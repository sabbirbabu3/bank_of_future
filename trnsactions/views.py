...
from trnsactions.constains import DEPOSIT,LOAN,WITHDRAW,LOAN_PAID
from datetime import datetime
from django.db.models import Sum
from django.core.mail import EmailMessage,EmailMultiAlternatives
from django.template.loader import render_to_string
from trnsactions.forms import (
    DepositForm,
    WithdrawForm,
    LoanRequestForm,
)
from trnsactions.models import Transaction
...
class WithdrawMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        user_transaction_email(self.request.user, "Withdrwal Massage","withdrwal_mail.html", amount )
